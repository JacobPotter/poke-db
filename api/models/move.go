...
// Move represents a move in the application. It contains properties such as ID, MoveType, TypeID, and Damage.
// The ID field is the unique identifier of the move.
// The MoveType field represents the type of the move.
